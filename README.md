...
| `compose.yaml` | AI viết bản đầu và giải thích bind mount, `user` theo UID host, `cap_drop`, `network_mode: none`; tôi đọc hiểu và chạy lại các lệnh kiểm tra (UID, CapEff, chủ sở hữu file) |
